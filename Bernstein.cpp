...
double Bezier(vector<vector<double> > PtsDeControles, double imin, double imax){
	...
	if(b-a < 0.001){
		return calculate(moitie, PtsDeControles);
	}else{
		...
		// for(double i=0; i<PtsDeControles1.size(); i++){
		// 	for(double j=0; j<2; j++){
		// 		cout << PtsDeControles1[i][j] << " ";
		// 	}
		// 	cout << endl;
		// }
		// cout << endl<< endl;
		// for(double i=0; i<PtsDeControles2.size(); i++){
		// 	for(double j=0; j<2; j++){
		// 		cout << PtsDeControles2[i][j] << " ";
		// 	}
		// 	cout << endl;
		// }
		// cout <<"--------------------------------------------------------------------------------"<< endl;
		...
		if(produit < 0){
			Bezier(PtsDeControles1, a, moitie);
			Bezier(PtsDeControles2, moitie, b);
		}
	}

}

vector<double> CastelJau(vector<vector<double> > PtsDeControles, double imin, double imax){
	vector<double> res;
	double x = 0 , y=0;
...
double calculate(double u, vector<vector<double> > PtsDeControles){
	double x = 0 , y = 0;
	double size = PtsDeControles.size()-1;
